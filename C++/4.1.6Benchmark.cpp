...
const int INSERTION_SORT_THRESHOLD = 10; // Ngưỡng cho Insertion Sort
...
int main() {
    vector<int> sizes = {5000, 10000, 20000}; // Kích thước mảng để kiểm tra
    for (int size : sizes) {
        vector<int> arr(size);
        ...
        chrono::duration<double, milli> duration = end - start; // Tính toán thời gian
